...
export default function SportsbettingHome() {
  ...
  const loadData = async () => {
    try {
      ...
      // Filter only sportsbetting sites
      const sportsbettingSites = allSites.filter(site => 
        site.type === 'sportsbetting' || 
      ...
      const sortedByGeo = sortSitesByAvailability(sportsbettingSites, currentUser?.country_code);
